              ...
              <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                      <form method="post" action="update_tpa.php">
                          ...
                          <?php endif ?>
                          <?php foreach ($db->select('hasil_tpa.*,program.id_calon_kr,program.nama','hasil_tpa,program')->where('hasil_tpa.id_calon_kr=program.id_calon_kr and hasil_tpa.id_calon_kr='.$_GET['id'])->get() as $data): ?>
