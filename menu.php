                ...
                <div class="col-md-12">
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-right">
                            ...
                            <li>
                                <a href="" data-toggle="dropdown" > Data</a>
                                <ul class="dropdown-menu">
                                    <li><a href="tampil_admin.php" id="AD">Data User</a></li>
                                    <li><a href="tampil_program.php" id="ck">Data Program Keuangan</a></li>
                                    <li><a href="tampil_kriteria.php" id="ds">Data Kriteria</a></li>
                                    <li><a href="tampil_subkriteria.php" id="sk">Data Sub Kriteria</a></li>
                                </ul>
                            </li>
                            <li><a href="tampil_tpa.php" id="tpa">Penilaian Program Keuangan</a></li>
