...
<?php include 'menu.php';?>
    <div class="content-wrapper">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h4 class="page-head-line">Sub Data Kriteria</h4>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    ...
                    <table id="example1" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <?php if ($_SESSION['role'] != 'pimpinan'): ?>
                                    <td>
                                        <a class="btn btn-warning" href="edit_subkriteria.php?id=<?php echo $data['id_subkriteria']?>">Edit</a>
                                        <a class="btn btn-danger" onclick="return confirm('Yakin Hapus?')" href="delete_subkriteria.php?id=<?php echo $data['id_subkriteria']?>">Hapus</a>
                                    </td>
                                <?php endif; ?>
                            </tr>
                            <?php $no++; endforeach; ?>
